...
export const Skills: React.FC = () => {
 ...
 useEffect(() => {
  ...
  return (
    <div
      ref={skillRef}
      className="skill_section font-sora flex flex-col w-full h-full px-[5%] py-[2%] mt-9"
    >
      <div
        className={`text-4xl font-medium text-center mb-10 text-[--black] font-sora flex flex-row justify-center gap-2 ${
          isVisible ? "fade-in" : ""
        }`}
      >
