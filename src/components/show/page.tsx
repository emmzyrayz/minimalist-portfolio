...
export const Show = () => {
    return (
      <div className="show_section flex md:flex-row flex-col-reverse relative w-[98vw] lg:h-[80vh] md:p-3 p-3 lg:top-5 items-center justify-center overflow-hidden font-sora md:gap-0 gap-5">
        <div className="show_text flex flex-col relative lg:mt-[15%] md:mt-[7%] lg:-left-0 md:-left-16 md:w-[80%] w-full  p-3 h-full lg:p-5 md:p-3 lg:gap-16 md:gap-3 gap-3">
          ...
          <div className="social_icons flex flex-row items-center md:justify-start justify-center w-full h-full relative gap-4 lg:ml-20">
            <Link
              href="#"
